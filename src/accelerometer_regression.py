...
def process():
    ...
    # Read the data
    df = pd.read_csv('data/clean_acceletomerer.csv')
    ...
    for dimension in dimensions:
        ...
        # Merge on angle
        merged_df = pd.merge(recorded_agg, calculated_agg, on='angle', suffixes=('_recorded', '_calculated'))
        ...
        plt.plot(merged_df['value_recorded'], y_pred, color='red', linewidth=2)
